...
/**
 * @private
 * 2D joint bilateral filter stage - single pass with full kernel
 * Provides superior edge quality compared to separable (2-pass) filter
 */
export class JointBilateralFilterStage extends WebGL2Pipeline.ProcessingStage {
        ...
        fragmentShaderSource: `#version 300 es
          ...
          void main() {
            ...
            if (totalSegAlpha <= 0.0) {
              ...
              outColor = vec4(newVal * centerColor, newVal);
            }
          }
        `,
        glOut,
        height,
        textureUnit: inputTextureUnit + 1,
        type: 'canvas',
        width,
        uniformVars: [
          {
