 ...
 * @private
 */
export declare class BackgroundProcessor extends Processor {
    ...
    protected constructor(backgroundProcessorPipeline: BackgroundProcessorPipeline | BackgroundProcessorPipelineProxy, options: BackgroundProcessorOptions);
    /**
