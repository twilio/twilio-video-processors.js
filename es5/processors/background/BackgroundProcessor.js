...
var BackgroundProcessor = /** @class */ (function (_super) {
    ...
    function BackgroundProcessor(options) {
        ...
        _this.historyCount = options === null || options === void 0 ? void 0 : options.historyCount;
    ...
    Object.defineProperty(BackgroundProcessor.prototype, "historyCount", {
        /**
         * @private
         */
        get: function () {
        ...
        set: function (count) {
            if (!count) {
                console.warn("Valid history count not found. Using " + constants_1.HISTORY_COUNT + " as default.");
                count = constants_1.HISTORY_COUNT;
            }
    ...
    BackgroundProcessor.prototype._createPersonMask = function (segment) {
        ...
        var _loop_1 = function (i) {
            var m = i * 4;
            var hasPixel = this_1._masks.some(function (mask) { return mask.data[i] === 1; });
            var w = this_1._masks.reduce(function (sum, mask, j) { return sum + mask.data[i] * (j + 1) * (j + 1); }, 0) / weightedSum;
