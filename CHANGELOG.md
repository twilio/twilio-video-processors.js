...
* The VideoProcessors now support the WebGL2 pipeline in addition to the Canvas2D pipeline. On Chrome, our tests show up to 30% reduction in CPU usage if WebGL2 is used as opposed to Canvas2D.
