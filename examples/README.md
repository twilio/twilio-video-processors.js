...
- `hysteresis=true|false` - Toggle temporal mask smoothing to reduce flickering (default: true)
- `hysteresisHigh` - Upper alpha threshold; pixels at or above are snapped to foreground (default: 180)
- `hysteresisLow` - Lower alpha threshold; pixels at or below are snapped to background (default: 80)
